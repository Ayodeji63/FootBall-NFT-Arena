 ...
 * @author  thirdweb.com
 */
contract DirectListingsLogic is IDirectListings {
    /*///////////////////////////////////////////////////////////////
    ...
    //     require(
    //         PermissionsEnumerableLogic(address(this)).hasRoleWithSwitch(
    //             LISTER_ROLE,
    //             _msgSender()
    //         ),
    //         "!LISTER_ROLE"
    ...
    modifier onlyListingCreator(uint256 _listingId) {
        ...
        require(
            data.listings[_listingId].listingCreator == msg.sender,
    ...
    function updateListing(
        ...
        {
            uint256 _approvedCurrencyPrice = data.currencyPriceForListing[
                _listingId
            ][_params.currency];
            require(
    ...
    function approveBuyerForListing(
        ...
        require(
            data.listings[_listingId].reserved,
    ...
    function approveCurrencyForListing(
        ...
        require(
            data.currencyPriceForListing[_listingId][_currency] !=
                _pricePerTokenInCurrency,
            "Marketplace: price unchanged."
        );

        data.currencyPriceForListing[_listingId][
            _currency
        ] = _pricePerTokenInCurrency;
    ...
    function buyFromListing(
        ...
        require(
            !listing.reserved ||
                data.isBuyerApprovedForListing[_listingId][buyer],
            "buyer not approved"
        );
        require(
